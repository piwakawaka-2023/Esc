...
exports.seed = async function (knex) {
  ...
  await knex('scenes').insert([
    ...
    },
    {
      id: 4,
      level_id: 5,
      text: "7:17 PM: oh, you made it out of the building? Well, thats great then! uhh... i suppose we'll see you tomorrow then.",
      final: false,
      slack: "7:18 PM: 👍 I will remind #teams-meeting at 10:30AM tomorrow morning.",
    },
    {
      id: 5,
      level_id: 0,
      ...
      final: true,
      slack: "7:48 PM: Spread love everywhere you go.",
    },
  ])
}
