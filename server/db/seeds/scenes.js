...
exports.seed = async function (knex) {
  ...
  await knex('scenes').insert([
    ...
    },
    {
      id: 3,
      level_id: 4,
      text: 'WOW, Thanks so much for grabbing my swipecard! Luckily you got out of there before the javascript carnival gang got to you!! Hope you remember the pin code on the way out lol',
      final: false,
    ...
    },
    {
      id: 4,
      level_id: 5,
      text: 'oh you got out... well i hear youve been vaping etc',
      final: false,
      slack: 'Message from Slack',
    },
    {
      id: 5,
      level_id: 0,
      text: 'hmmm you made it. well done i guess',
      final: true,
      slack: 'Message from Slack',
    },
  ])
